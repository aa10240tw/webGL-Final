...
var lightPosition = vec4( 3.0, 2.0, 0.0, 1.0 );

var materialAmbient = vec4( 0.8, 0.0, 0.0, 1.0 );
var materialDiffuse = vec4( 0.8, 0.0, 0.8, 1.0);
var materialSpecular = vec4( 0.0, 10.0, 0.0, 1.0 );
...
window.onload = function init()
{
	...
	// *** Lab Exercise 1: Add the ARRAY_BUFFER and vertex attribute for the texture coordinates
	// Hint: You will need to call gl.createBuffer(), gl.bindBuffer(), gl.bufferData(), 
	//       gl.getAttribLocation, ...etc.
    ...
    document.getElementById( "fButton" ).onclick = function() {eyePosition[2]-=0.05;}
    document.getElementById( "bButton" ).onclick = function() {eyePosition[2]+=0.05;}
    document.getElementById( "rButton" ).onclick = function() {eyePosition[0]-=0.05;}
    document.getElementById( "lButton" ).onclick = function() {eyePosition[0]+=0.05;}
    document.getElementById( "plusFov" ).onclick = function() {FOV+=1;}
    document.getElementById( "subsFov" ).onclick = function() {FOV-=1;}
...
function render() {
	...
	viewing = lookAt(eyePosition, [eyePosition[0],0,0], [0,1,0]);

	projection = perspective(FOV, 1.0, 1.0, 100.0);
