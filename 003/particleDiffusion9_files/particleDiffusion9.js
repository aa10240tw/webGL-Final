...
window.onload = function init() {
    ...
    gl.uniform4f( gl.getUniformLocation(program2, "color"), 0.0, 0.5, 0.5, 1.0);
...
var render = function(){
   ...
   // render to texture
    ...
    gl.enableVertexAttribArray( vPosition2 );
    gl.vertexAttribPointer( vPosition2, 2, gl.FLOAT, false, 0, 0);
    gl.uniform4f( gl.getUniformLocation(program2, "color"), 0.8, 0.0, 0.0, 0.5);
    gl.drawArrays(gl.POINTS, 4, numPoints/2);
    gl.uniform4f( gl.getUniformLocation(program2, "color"), 1.0, 0.0, 1.0, 0.5);
...
// wrap arounds
    ...
    gl.enableVertexAttribArray( vPosition2 );
    gl.vertexAttribPointer( vPosition2, 2, gl.FLOAT, false, 0, 0);
    gl.uniform4f( gl.getUniformLocation(program2, "color"), 0.0, 0.2, 0.0, 1.0);
